                    ...
                    {brands.map((item, index) => {
                      return (
                        <Form.Check
                          ...
                          data-type="brands"
                          data-name={item}
                          checked={checkedMap.brands[item] || false}
                    ...
                    {types.map((item, index) => {
                      return (
                        <Form.Check
                          ...
                          data-type="types"
                          data-name={item}
                          checked={checkedMap.types[item] || false}
                          onChange={handleCheck}
                        />
                      );
                    })}
                    ...
                    {packages.map((item, index) => {
                      return (
                        <Form.Check
                          ...
                          data-type="packages"
                          data-name={item}
                          checked={checkedMap.packages[item] || false}
                          onChange={handleCheck}
                        />
                      );
                    })}
                    ...
                    {origins.map((item, index) => {
                      return (
                        <Form.Check
                          ...
                          data-type="origins"
                          data-name={item}
                          checked={checkedMap.origins[item] || false}
                          onChange={handleCheck}
                        />
                      );
                    })}
                    ...
                    {theStyles.map((item, index) => {
                      return (
                        <Form.Check
                          ...
                          data-type="theStyles"
                          data-name={item}
                          checked={checkedMap.theStyles[item] || false}
                          onChange={handleCheck}
                        />
                      );
                    })}
